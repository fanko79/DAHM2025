...
from utils.utils import get_local_time, early_stopping, dict2str, test_stopping
    ...
    def fit(self, train_data, valid_data=None, test_data=None, saved=False, verbose=True):
        ...
        for epoch_idx in range(self.start_epoch, self.epochs):
            ...
            if (epoch_idx + 1) % self.eval_step == 0:
                ...
                """
                self.best_test_score, self.cur_step, stop_flag, update_flag = test_stopping(
                    test_score, self.best_test_score, self.cur_step, epoch_idx,
                    max_epoch=self.epochs, bigger=self.valid_metric_bigger)
                """
                if verbose:
                ...
                if update_flag:
                    ...
                    update_output = '██ ' + self.config['model'] + '--Best results updated!!!' + 'cur_step: ' + str(self.cur_step)
                    if verbose:
